        ...
        <div className="containr mx-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                ...
                <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-4">
                    A Third-year AI & Data Science student skilled and experienced in ML, full-stack web development, and data analysis. Passionate about solving real-world problems with AI.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                    ...
                    <a
                        href="https://drive.google.com/file/d/1vUrWWPEtNVIs3xyGPaDqjIEzIwdOSN5u/view?usp=sharing" target="_blank" rel="noopener noreferrer"
